...
var $variable_name = { // eg: $transfer__variable_name Packet.options.variable
    ...
    //Request status
    'success':  $success,        // Boolean, if the request succeded or not

    'error':    $error,          // Mixed, checked if success == false
    ...
    'events': {
        'onPickUp':       $onPickUp,    // to be called immediately after pickup
        'onBeforeFail':   $onFail,      // to be called immediately before Packet.failize()
        'onAfterFail':    $onFail,      // to be called immediately after Packet.failize()
        'onBeforeSuccess':$onSuccess,   // to be called immediately Before Packet.finalize()
        'onAfterSuccess': $onSuccess    // to be called immediately after Packet.finalize()
    }
